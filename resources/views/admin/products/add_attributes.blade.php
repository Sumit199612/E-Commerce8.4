            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                  <input type="submit" value="Update" class="btn btn-primary btn-mini" title="">
                  <a rel="{{ $attribute->id }}" rell="delete-attribute" href="javascript:" class="btn btn-danger btn-mini deleteAttribute">Delete</a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
