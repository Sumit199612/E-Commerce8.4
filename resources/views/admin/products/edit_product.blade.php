          ...
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="product_color" id="product_color" value="{{$productDetails->product_code}}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="hidden" name="current_product_image" value="{{$productDetails->product_image}}">
                  @if(!empty($productDetails->product_image))
                  <img style="width:50px;" src="{{ asset('/images/backend_images/products/small/'.$productDetails->product_image) }}">
